...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <link rel="apple-touch-icon" sizes="76x76" href="<? echo base_url();?>/assets/images/rfsc.png">
        <link rel="icon" type="image/png" href="<? echo base_url();?>/assets/images/rfsc.png">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
        <title>
            <?php if(isset($title)){ echo $title;}?></title>
        <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0, shrink-to-fit=no' name='viewport' />
        <!--     Fonts and icons     -->
        <link rel="stylesheet" href="<? echo base_url();?>assets/iconfont/material-icons.css" />
        <link rel="stylesheet" href="<? echo base_url();?>assets/fontawesome/css/fontawesome-all.min.css" />
