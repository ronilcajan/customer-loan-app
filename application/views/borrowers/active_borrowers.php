                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-actions text-right">
                                                <button type="button" rel="tooltip" title="Go to Payments" class="btn btn-info btn-sm btn-link" onclick="location.href='<?php echo base_url().'payments/loan-details/'.$actv['loan_no'];?>'">
